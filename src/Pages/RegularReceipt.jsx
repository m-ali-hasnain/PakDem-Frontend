...
import { getRegularReciept } from "../api/Receipt";


function RegularReceipt() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const responseData = await getRegularReciept(); // Call the function to get the data
