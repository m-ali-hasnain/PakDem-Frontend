...
import { getAgentPaymentList } from "../api/Agents";


function AgentPaymentList() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const responseData = await getAgentPaymentList(); // Call the function to get the data
  ...
  return (
    ...
    >
        ...
        <DataTable data = { data }  nav = 'AgentPayment/details' isPayment = {false} />
    </Box>
    )
}
