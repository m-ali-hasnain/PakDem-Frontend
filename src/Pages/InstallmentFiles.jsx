...
import { getInstallmentFiles } from "../api/MainAppFrom";
import { useTheme } from '@emotion/react';
import { useNavigate } from "react-router-dom";
import DataTable from "../Components/Table";


function InstallmentFiles() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const responseData = await getInstallmentFiles(); // Call the function to get the data
