...
export const getCommission = async (agentName) => {
    try {
      
      const response = await Axios.get('/AgentRecord/agentCommission' , {
                                        params: { agentName },
                                       });
  ...
  export const getFiles = async (agentName) => {
    try {
      ...
      const response = await Axios.get('/AgentRecord/agentFiles' , {
                                        params: { agentName },
                                       });
